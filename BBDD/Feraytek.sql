-- ======================================================================
-- PROYECTO: FERAYTEK (E-commerce)
-- Autor: Ayala & Fernández [UTN - FR Re]
-- Fecha: Octubre 2025
-- Descripción: Script completo, ordenado y documentado de la base de datos.
-- ======================================================================
-- ⚠️ ATENCIÓN: esto eliminará completamente la base de datos y su contenido (usarios y previlegios)
/* 
DROP DATABASE IF EXISTS feraytek;
...
/* ======================================================================
   5) RESEÑAS, DESCUENTOS, SOPORTE, LOGS, HISTORIAL
   ----------------------------------------------------------------------
   Propósito del módulo:
   - Reseñas de productos, cupones/discounts, tickets de soporte,
     auditoría básica y cambios de estado de pedidos.
   ====================================================================== */

-- ----------------------------------------------------------------------
-- Tabla: reseñas
-- Calificaciones y comentarios de usuarios sobre productos.
-- ----------------------------------------------------------------------
CREATE TABLE resenas (
  id_reseña        INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,  -- PK técnica
  id_producto      INT UNSIGNED NOT NULL,                    -- FK al producto reseñado
  id_usuario       INT UNSIGNED NOT NULL,                    -- autor de la reseña
  calificacion     TINYINT UNSIGNED NOT NULL,                -- 1..5
  comentario       TEXT NULL,                                -- texto libre
...
-- Un usuario sólo puede reseñar un producto una vez
CREATE UNIQUE INDEX uq_resena_prod_user ON resenas(id_producto, id_usuario);
